...
public extension NSMutableAttributedString {
    ...
    convenience init(source: String, tokens: [SKToken], theme: SKSyntaxColorTheme) {
		...
		let themeInfo = SKThemeInfo(theme: theme, spaceWidth: spaceWidth)
		...
		for token in tokens {
			...
			if token.isEditorPlaceholder {
				...
				attr[.editorPlaceholder] = SKEditorPlaceholderState.inactive
